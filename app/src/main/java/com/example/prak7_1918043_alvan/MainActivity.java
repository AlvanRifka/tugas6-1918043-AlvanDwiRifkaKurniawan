package com.example.prak7_1918043_alvan;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startOneTimeTask(){
        ...
        Data data = new Data.Builder()
                .putString(MyWorkManager.EXTRA_CITY,spCity.getSelectedItem().toString())
                .build();
    ...
    private void startPeriodicTask(){
        ...
        periodicWorkRequest = new PeriodicWorkRequest.Builder(MyWorkManager.class, 15, TimeUnit.MINUTES)
                .setInputData(data)
                .setConstraints(constraints)
                .build();
